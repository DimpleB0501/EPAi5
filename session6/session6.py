...
def next_fibonacci_number():
    ...
    def generate_number(num) -> int:
        """
        input: number till you want to generate the fibonacci number
        output: generated fibonacci number
        """
        nonlocal num1, num2
        next_num = num1 + num2
...
def add (num1: Number, num2: Number) -> Number:
    ...
    if isinstance(num1, (int, float)) and isinstance(num2, (int, float)):
        ...
        raise TypeError("Can add only integers or floats")
...
def mul (num1: Number, num2: Number) -> Number:
    ...
    if isinstance(num1, (int, float)) and isinstance(num2, (int, float)):
        ...
        raise TypeError("Can multiply only integers or floats")
...
def div (numerator: Number, denominator: Number) -> Number:
    ...
    if isinstance(numerator, (int, float)) and isinstance(denominator, (int, float)):
        ...
        raise TypeError("Can divide only integers or floats")
...
def func_counter_variable_dict(fn, dict_counter:dict):
    ...
    output: global dictionary variable with the updated counts
    """
